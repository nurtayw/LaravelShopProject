...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <a class="navbar-brand ps-3" href="">Male fashion</a>
    ...
    <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
        ...
        <span class="nav-link dropdown-toggle" id="navbarDropdown2" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">{{ config('app.languages') [app()->getLocale()]}}<i class="arrow_carrot-down"></i></span>
            <ul  class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown2">
                <li class="nav-item">
                    @foreach(config('app.languages') as $ln => $lang)
                        <a style="color: black; text-decoration: none" class="nav-item" href="{{route('switch.lang', $ln)}}">
                            {{$lang}}
                        </a><br>
                    @endforeach
                </li>
